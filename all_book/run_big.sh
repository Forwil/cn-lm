...
python main.py --gpuid 1 --data ../data/all_and_book --cuda --log-interval 1 --emsize 1500 --nhid 1500 --dropout 0.65 --epochs 10 --tied --save all_book_big.pt         # Test perplexity of 80.
