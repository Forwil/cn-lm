...
python main.py --gpuid 0 --data ../data/all_and_book_re --cuda --log-interval 1 --emsize 1500 --nhid 1500 --dropout 0.65 --epochs 10 --tied --save all_book_big_re.pt        # Test perplexity of 80.
